...
namespace Harbour.DBUtils
{
    ...
    public class DbHelperOleDb
    {
        ...
        /// <param name="cmdParms">参数列表</param>
        /// <returns></returns>
        public List<T> ExeReaEntList<T>(string SQLString, params OleDbParameter[] cmdParms) where T : new()
        {
        ...
        /// <param name="cmdParms">参数列表</param>
        /// <returns></returns>
        public T QueryEntity<T>(string SQLString, params OleDbParameter[] cmdParms) where T : new()
        {
        ...
        /// <param name="cmdParms">参数列表</param>
        /// <returns></returns>
        public List<T> QueryEntList<T>(string SQLString, params OleDbParameter[] cmdParms) where T : new()
        {
            DataSet ds = Query(SQLString, cmdParms);
