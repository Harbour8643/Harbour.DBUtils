...
namespace Harbour.DBUtils
{
    ...
    public class DbHelperSQL
    {
        ...
        /// <param name="cmdParms">参数列表</param>
        /// <returns></returns>
        public T ExeReaEntity<T>(string SQLString, params SqlParameter[] cmdParms) where T : new()
        {
        ...
        /// <param name="cmdParms">参数列表</param>
        /// <returns></returns>
        public List<T> ExeReaEntList<T>(string SQLString, params SqlParameter[] cmdParms) where T : new()
        {
        ...
        /// <param name="cmdParms">参数列表</param>
        /// <returns></returns>
        public T QueryEntity<T>(string SQLString, params SqlParameter[] cmdParms) where T : new()
        {
        ...
        /// <param name="cmdParms">参数列表</param>
        /// <returns></returns>
        public List<T> QueryEntList<T>(string SQLString, params SqlParameter[] cmdParms) where T : new()
        {
            DataSet ds = Query(SQLString, cmdParms);
